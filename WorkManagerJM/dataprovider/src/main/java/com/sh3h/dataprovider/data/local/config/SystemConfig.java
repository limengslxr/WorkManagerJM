...
public class SystemConfig extends BaseConfig {
     ...
     * 数据备用后台地址
     */
    public static final String PARAM_SERVER_REVERSE_BASE_URI = "server.reverse.baseuri";
    /**
     * 后台表务地址
     */
    public static final String PARAM_SERVER_METER_BASE_URI = "server.meter.baseuri";
    /**
     * 抢单地址
     */
    public static final String PARAM_SERVER_GRAB_URI = "server.grab.uri";
