...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            File cacheDir = new File(sdDir, ConfigHelper.FOLDER_LOG);
            if (!cacheDir.exists())
                cacheDir.mkdirs();
    ...
    public static void backupDatabase() {
        ...
        oldFile = new File(sdDir, ConfigHelper.FOLDER_DATA + File.separator + ConfigHelper.DB_NAME);
        newFile = new File(sdDir, ConfigHelper.FOLDER_DATA + File.separator +
                TextUtil.format(new Date(), "yyyyMMddHHmmss") + ".cbj");
