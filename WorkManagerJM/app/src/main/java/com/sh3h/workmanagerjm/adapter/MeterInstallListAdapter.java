 ...
 * 装表列表
 */
public class MeterInstallListAdapter extends AbstractAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_meter_install_list, parent, false);
        return new MeterInstallHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof MeterInstallHolder) {
            MeterInstallHolder holder = (MeterInstallHolder) viewHolder;
    ...
    private class MeterInstallHolder extends RecyclerView.ViewHolder {
        private TextView tvCardId, tvCardName, tvAddress, tvResolvePerson, tvEndDate, tvRegisterTime;
