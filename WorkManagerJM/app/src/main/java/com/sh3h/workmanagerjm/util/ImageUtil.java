...
class ImageUtil {
    ...
    static File compressImage(String imagePath, int reqWidth, int reqHeight,
                              Bitmap.CompressFormat compressFormat, int quality, File destinationFile)
            throws IOException {
        File imageFile = new File(imagePath);
        FileOutputStream fileOutputStream = null;
        File file = destinationFile.getParentFile().getParentFile();
        if (!file.exists()) {
            file.mkdirs();
        }
        try {
