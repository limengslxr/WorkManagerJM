...
public class SystemWebChromeClient extends WebChromeClient {
    ...
    public void onExceededDatabaseQuota(String url, String databaseIdentifier, long currentQuota, long estimatedSize,
        ...
        LogUtil.d(LOG_TAG, "onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d",
    ...
    public void onConsoleMessage(String message, int lineNumber, String sourceID) {
        ...
        if (android.os.Build.VERSION.SDK_INT == android.os.Build.VERSION_CODES.ECLAIR_MR1) {
            LogUtil.d(LOG_TAG, "%s: Line %d : %s", sourceID, lineNumber, message);
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        if (consoleMessage.message() != null)
            LogUtil.d(LOG_TAG, "%s: Line %d : %s", consoleMessage.sourceId(), consoleMessage.lineNumber(), consoleMessage.message());
    ...
    public boolean onShowFileChooser(WebView webView, final ValueCallback<Uri[]> filePathsCallback, final WebChromeClient.FileChooserParams fileChooserParams) {
        ...
        try {
            ...
            LogUtil.w("No activity found to handle file chooser intent.", e.getMessage());
