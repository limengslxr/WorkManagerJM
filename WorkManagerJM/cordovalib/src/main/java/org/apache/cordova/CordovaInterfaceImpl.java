...
public class CordovaInterfaceImpl implements CordovaInterface {
            ...
            if(pluginManager != null)
            {
                ...
                if(appPlugin != null) {
                    ...
                    try {
                        ...
                        LogUtil.e(TAG, "Failed to create event message", e);
                    }
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (callback != null) {
            LogUtil.d(TAG, "Sending activity result to plugin");
            initCallbackService = null;
            savedResult = null;
            callback.onActivityResult(requestCode, resultCode, intent);
            return true;
        }
        LogUtil.w(TAG, "Got an activity result, but no plugin was registered to receive it"
    ...
    @Override
    public boolean updateToolbar(String title, boolean showSearch, boolean showRefresh, boolean showGrabWork) {
        return false;
    }
}
