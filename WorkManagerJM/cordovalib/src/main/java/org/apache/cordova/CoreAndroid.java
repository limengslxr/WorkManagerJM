...
class CoreAndroid extends CordovaPlugin {
    ...
    private void sendEventMessage(String action, Object text) {
        JSONObject obj = new JSONObject();
        try {
            obj.put("action", action);
            obj.put("searchKey", text);
        } catch (JSONException e) {
    ...
    public Object onMessage(String id, Object data) {
        switch (id) {
            case "refreshMenu":
                sendEventMessage("refreshMenu", null);
                break;
            case "grabWork":
                sendEventMessage("grabWork", null);
                break;
            case "searchKey":
                sendEventMessage("searchKey", data);
                break;
            default:
                return null;
        }
